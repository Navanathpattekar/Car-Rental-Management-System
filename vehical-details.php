...
<?php }} ?>
      <aside style="margin-right:30px;">
          ...
          <?php if($_SESSION['login'])
              ...
              <?php } else { ?>
<a href="#loginform" class="btn btn-xs uppercase" data-toggle="modal" data-dismiss="modal"><div style="border:1px solid black;padding:3px;text-align:center;margin-top:20px;">Login For Book</div></a>
              <?php } ?>
          </form>
      </aside>
      </section>
