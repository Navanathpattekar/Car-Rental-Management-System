...
$sql ="SELECT admin_name,password FROM admin WHERE admin_name=:email and password=:password";
...
<body>
	<div class="login-page bk-img" style="background-image: url(img/login-bg.jpg);background-repeat:no-repeat;background-size:100%;height:100vh;">
